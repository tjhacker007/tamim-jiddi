...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            InlineKeyboardButton('😈⚠️ I M TJ Add Me To Your Groups ⚠️😈', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('💖 Movie Link Channel 💖', url=f"https://telegram.me/+aFTtRQy6CJRjZGM1"),
            InlineKeyboardButton('🔔 BOT Head 🤖', url='https://t.me/+oIhZr9dUuh03NmI9')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('JOIN', url='https://t.me/+aFTtRQy6CJRjZGM1')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
